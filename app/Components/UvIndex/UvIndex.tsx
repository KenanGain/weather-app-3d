...
function UvIndex() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col gap-5 dark:bg-black/50 dark:backdrop-blur-sm shadow-sm ">
      <div className="top">
        <h2 className="flex items-center gap-2 text-md font-medium">{sun} Uv Index</h2>
